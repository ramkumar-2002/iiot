...
#define WIFI_SSID "your_wifi_ssid" #define WIFI_PASS "your_wifi_password" #define ADAFRUIT_IO_USERNAME "your_adafruit_io_username" #define ADAFRUIT_IO_KEY "your_adafruit_io_key" #define MOTOR_PIN 2
WiFiClient client;
